 ...
 */
public class ClasificacionRAM extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Clasificacion por RAM");
    ...
    private void btnCompactarInsituActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCompactarInsituActionPerformed
        try {
            cine.ClasificacionEnRAM();
            JOptionPane.showMessageDialog(null, "Clasificacion Terminada");
        } catch (IOException ex) {
            Logger.getLogger(ClasificacionRAM.class.getName()).log(Level.SEVERE, null, ex);
        }
