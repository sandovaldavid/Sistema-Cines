 ...
 */
public class ClasificacionIndirecciones extends javax.swing.JInternalFrame {
     ...
     */
    public ClasificacionIndirecciones() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Clasificacion por Indirecciones");
    ...
    private void btnCompactarInsituActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCompactarInsituActionPerformed
        try {
            cine.ClasificacionIndirecciones();
            JOptionPane.showMessageDialog(null, "Clasificacion Terminada");
        } catch (IOException ex) {
            Logger.getLogger(ClasificacionIndirecciones.class.getName()).log(Level.SEVERE, null, ex);
        }
